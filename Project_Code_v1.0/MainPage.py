...
def MainPage(parent, show_login, show_signup):
    ...
    logo = Image.open("Project_Code_v1.0/PNGs/logo.png")  # Path to your image file
...
def main():
    ...
    def create_buttons():
        logout_icon = ImageTk.PhotoImage(Image.open("Project_Code_v1.0/PNGs/logout_icon.png").resize((30, 30)))
        ...
        settings_icon = ImageTk.PhotoImage(Image.open("Project_Code_v1.0/PNGs/settings_icon.png").resize((30, 30)))
