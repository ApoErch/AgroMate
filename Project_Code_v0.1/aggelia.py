...
class SellProductsApp(tk.Toplevel):
    ...
    def create_ad_form(self, parent_frame, coupon=None):
        ...
        ctk.CTkButton(self.ad_form_frame, text="Submit Ad",fg_color="#00FF00", text_color="#2E2E2E", corner_radius=8, command=self.submit_ad).pack()
    ...
    def display_ad_with_random(self, user_ad, random_ad):
        ...
        ctk.CTkButton(self.display_frame, text="Choose Friends", command=self.choose_friends).pack(pady=10)
